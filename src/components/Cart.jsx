...
const Cart = () => {
  ...
  const handlePaymentClick = () => {
    // Открытие локального HTML-файла с указанием абсолютного пути
    window.open('./oplata.html', '_blank');
  };
  ...
  return (
    <Card sx={{ maxWidth: '100%', margin: 2, boxShadow: 3 }}>
      <CardContent>
        ...
        <Button onClick={handlePaymentClick} variant="contained" color="success" sx={{ mt: 2 }}>
          Перейти к оплате
        </Button>
      </CardContent>
    </Card>
